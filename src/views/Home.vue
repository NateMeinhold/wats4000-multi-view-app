  ...
  <div class="home">
    <div class="form-container" v-show="showForm">
      ...
      <p
        class="error"
        v-show="showError"
      >Please checked the information you have entered. Be sure to fill in all the fields.</p>
...
export default {
  ...
  methods: {
    validateForm: function() {
      if ((this.username !== '') &&
      (this.email !== '') &&
      //check for empty password..might be related to if this.password = null..but research
